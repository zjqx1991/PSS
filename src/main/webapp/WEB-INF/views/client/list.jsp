            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_center">
                        ...
                        客户电话
                        <s:textfield name="qo.tel" cssClass="ui_input_txt02"/>
                    </div>
                    <div id="box_bottom">
                        <input type="button" value="查询" class="ui_input_btn01 next_btn" data-page="1"/>
                        <input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="client_input"/>
                        <input type="button" value="批量删除" class="ui_input_btn01 btn_batch"
                               data-url="client_deleteBatch"/>
                    </div>
                </div>
            </div>
        </div>
