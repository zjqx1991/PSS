...
<s:form id="searchForm" action="stockOutBill" method="post">
    <div id="container">
            ...
            <div class="ui_text_indent">
                <div id="box_border">
                    ...
                    <div id="box_bottom">
                        ...
                        <input type="button" value="新增" class="ui_input_btn01 btn_input" data-url="stockOutBill_input"/>
                            <%--                        <input type="button" value="批量删除" class="ui_input_btn01 btn_batch"--%>
                            <%--                               data-url="stockOutBill_deleteBatch"/>--%>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <s:iterator value="#pageResult.resultList">
                        <tr>
                            ...
                            <s:if test="status == 0">
                                ...
                                <td>
                                    <s:a namespace="/" action="stockOutBill_audit">
                                        <s:param name="stockOutBill.id" value="id"/>
                                        审核
                                    </s:a>
                                    <s:url var="editURL" namespace="/" action="stockOutBill_input">
                                        <s:param name="stockOutBill.id" value="id"/>
                                    </s:url>

                                    <a href="<s:property value="editURL"/>">编辑</a>

                                    <s:url var="deleteURL" namespace="/" action="stockOutBill_delete">
                                        <s:param name="stockOutBill.id" value="id"/>
                                    </s:url>
                            ...
                            <s:elseif test="status == 1">
                                ...
                                <td>
                                    <s:a namespace="/" action="stockOutBill_show">
                                        <s:param name="stockOutBill.id" value="id"/>
                                        查看
                                    </s:a>
                                </td>
